...
def detect_violence(feat_path, model_path, device='cuda'):
    ...
    args, _ = xd_option.parser.parse_known_args()
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 3:
        print("使用方法: python demo.py <特征文件路径> <模型权重路径>")
        sys.exit(1)
...
# python src/demo.py /data1/lihenghao/data/XDTestClipFeatures/wangted.2008__#0-27-17_0-28-07_label_A__9.npy /data1/lihenghao/code/VadCLIP/modelxd/model_xd.pth